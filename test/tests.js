...
function quizScore(jacksAnswer, denisesAnswer, erinsAnswer, leighAnnsAnswer) {
    ...
    if(jacksAnswer === "waterskiing" || jacksAnswer === "lacrosse"){
        score++;
    }

    if(denisesAnswer === "tacos" || denisesAnswer === "running"){
        score++;
    }

    if(erinsAnswer === "poetry" || erinsAnswer === "traveling"){
        score++;
    }

    if(leighAnnsAnswer === "eurovision" || leighAnnsAnswer === "puppies"){
        score++;
    }
